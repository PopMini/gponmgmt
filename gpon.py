...
if __name__ == '__main__':
	...
	olt5 = olt('192.168.230.106','t0p$3cr37')
	...
	olt5x = pool.apply_async(olt5.getOnuInfo,)
	...
	olt2x = pool.apply_async(olt2.addToDatabase,)
	olt3x = pool.apply_async(olt3.addToDatabase,)
	olt4x = pool.apply_async(olt4.addToDatabase,)
	olt5x = pool.apply_async(olt5.addToDatabase,)
	olt6x = pool.apply_async(olt6.addToDatabase,)
	olt7x = pool.apply_async(olt7.addToDatabase,)
